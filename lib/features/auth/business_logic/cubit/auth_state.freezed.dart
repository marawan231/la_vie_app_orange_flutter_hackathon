...
/// @nodoc
abstract class $AuthResultStateCopyWith<T, $Res> {
  factory $AuthResultStateCopyWith(
          AuthResultState<T> value, $Res Function(AuthResultState<T>) then) =
      _$AuthResultStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$AuthResultStateCopyWithImpl<T, $Res>
    implements $AuthResultStateCopyWith<T, $Res> {
  _$AuthResultStateCopyWithImpl(this._value, this._then);

  final AuthResultState<T> _value;
  // ignore: unused_field
  final $Res Function(AuthResultState<T>) _then;
}
...
abstract class Idle<T> implements AuthResultState<T> {
...
class _$Loading<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'AuthResultState<$T>.loading()';
  }
...
abstract class Loading<T> implements AuthResultState<T> {
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'AuthResultState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements AuthResultState<T> {
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'AuthResultState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements AuthResultState<T> {
